      ...
      <Paper elevation={3} sx={{ p: 4, borderRadius: 3, backgroundColor: "#f9f9f9" }}>
        ...
        <Box sx={{ mt: 3 }}>
          <Typography variant="body1" sx={{ color: "#444", mb: 2, fontSize: "1.1rem" }}>
            <strong>ModelMaster</strong> — бұл мектеп оқушылары мен студенттерге 3D модельдеу мен 3D басып шығаруды үйренуге арналған инновациялық платформа. Біздің миссиямыз – интерактивті құралдар мен оқулықтардың көмегімен цифрлық өндіріс әлемін қолжетімді ету.
          </Typography>
